...
#include <robotiq_3f_gripper_msgs/SModelRobotInput.h>
...
void changeCallback(robotiq_3f_gripper_control::SModelEtherCatClient& client,
                    const robotiq_3f_gripper_control::SModelEtherCatClient::GripperOutput::ConstPtr& msg)
{
