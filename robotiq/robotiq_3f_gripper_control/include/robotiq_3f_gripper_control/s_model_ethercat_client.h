...
#include <robotiq_3f_gripper_msgs/SModelRobotOutput.h>
...
{
public:
  typedef robotiq_3f_gripper_msgs::SModelRobotOutput GripperOutput;
  typedef robotiq_3f_gripper_msgs::SModelRobotInput GripperInput;
